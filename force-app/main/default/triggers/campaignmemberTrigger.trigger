/*
Created by: Colin Johnson, Aprika Business Solutions (colin.johnson@aprika.com.au)
Created date: 8th February 2013
Purpose: Add a task to the related Lead record for campaign activity visibility for the Customer Acquisition Campaigns
Project: Green Shoots
...
trigger campaignmemberTrigger on CampaignMember (After Update) {
    ...
    //Declare variables
    Task[] tNew = new Task[]{}; //List of new Tasks to be created
...
System.debug('### formSignedLeadIdList:' + formSignedLeadIdList);
    ...
    list<Lead> leads = [SELECT id,
                            ...
                            Account_No__c,
                            Company
                        from Lead where id IN :formSignedLeadIdList];
