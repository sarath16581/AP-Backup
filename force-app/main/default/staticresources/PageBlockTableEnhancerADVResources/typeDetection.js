...
jQuery.extend( jQuery.fn.dataTableExt.oSort, {
    "currency-pre": function ( a ) {
        a = stripHtmlTags((a==="-") ? 0 : a.replace( /[^\d\-\.]/g, "" ));
        return parseFloat( a );
    },
 
    "currency-asc": function ( a, b ) {
        /* Remove any formatting */
        var x = (a==="-" || a==="" || isNaN(a)) ? 0 : a;
        var y = (b==="-" || b==="" || isNaN(b)) ? 0 : b;
...
jQuery.fn.dataTableExt.aTypes.unshift(
   function ( sData )
    {
        sData = stripHtmlTags(sData);
        
        if ( typeof sData !== 'string' || re.test(sData) ) {
            return null;
        }
