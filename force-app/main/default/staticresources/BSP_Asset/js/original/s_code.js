...
s.linkInternalFilters="javascript:,auspost.com.au,movingservices.com.au,postbillpay.com,eletter.com.au,australianlifestylesurvey.com.au,australiatodaymag.com.au,auspostbrand.com.au,mailmarketing.com.au,stamps.com.au,edeliver.com.au,personalisedstamps.com.au,openuptomail.com,messengerpost.com.au,sprintpak.com.au,transpromo.com.au,auspostnsw.nga.net.au";
s.linkLeaveQueryString=false;
s.linkTrackVars="None";
s.linkTrackEvents="None";

/* TimeParting Config */
s.dstStart="26/9/2010";
s.dstEnd="4/3/2011";
var tDate=new Date();
...
function s_doPlugins(s) {
	...
	if(!s.pageName) {
		...
		s.pageName=s.prop1+":"+s.pageName.toLowerCase();
	}
	...
	/* Content Hierarchy from PageName */
		if(!s.channel){ 
			...
			if(valueArray[1]!=undefined && valueArray[1].lastIndexOf(".") == -1){
				s.channel=valueArray[0]+':'+valueArray[1];						
				if(valueArray[2]!=undefined && valueArray[2].lastIndexOf(".") == -1){
					s.prop2=valueArray[0]+':'+valueArray[1]+':'+valueArray[2];
					if(valueArray[3]!=undefined && valueArray[3].lastIndexOf(".") == -1){
						s.prop3=valueArray[0]+':'+valueArray[1]+':'+valueArray[2]+':'+valueArray[3];
					} else {
						s.prop3=s.prop2;
					}
				} else {
	...
	/* Rebuild pageName to have site, site section and page name */
		if(s.pageName != "" && s.pageName != undefined){
			var pageNameArray = s.pageName.split(":");
			
			if(pageNameArray.length > 2 && (pageNameArray[1] == "pers" || pageNameArray[1] == "busi" || pageNameArray[1] == "allp" || pageNameArray[1] == "work" || pageNameArray[1] == "abou"))
				s.pageName = pageNameArray[0] + ":" + pageNameArray[1] + ":" + pageNameArray[pageNameArray.length - 1];
		}
	...
	/* Time Parting */
		s.prop22=s.eVar22=s.getTimeParting('h','10'); // Set hour
		s.prop23=s.eVar23=s.getTimeParting('d','10'); // Set day
		s.prop24=s.eVar24=s.getTimeParting('w','10'); // Set weekday
...
/*
 * Plugin: getTimeParting 2.0 - (Modified to include Minute tracking)
 */
...
+"var dow=days[thisd];var ap='AM';var dt='Weekday';var mint='00';var min"
+"t1=thismin;if(thismin<10){mint1='0'+thismin}"
+"if(thismin>30){mint='30'}if(thish>=12){ap='PM';thish=thish-12};"
+"if (thish==0){thish=12};if(thisd==6||thisd==0){dt='Weekend'};"
+"var timestring=thish+':'+mint+ap;var minstring=thish+':'+mint1+ap;if(t="
+"='h'){return timestring} if(t=='d'){return dow};if(t=='m'){return minst"
+"ring};if(t=='w'){return dt}}};"
);
...
s.visitorNamespace="australiapost"
s.trackingServer="australiapost.122.2o7.net"
