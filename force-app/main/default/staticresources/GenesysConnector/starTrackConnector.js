...
class GenSTBusinessLogic {
    callLog;
	stFieldMappings = {
        enquiryType: 'attributes.Participant\\.Dim_Attribute_2',
        consignmentNumber: 'attributes.Participant\\.Record_ID',
        phoneNumber: 'attributes.Call\\.Ani',
        ...
        partyType: 'attributes.Participant\\.Party_Type'
    };
