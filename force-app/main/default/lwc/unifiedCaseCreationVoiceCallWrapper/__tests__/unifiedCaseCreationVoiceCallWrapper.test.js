...
import UnifiedCaseCreationVoiceCallWrapper from 'c/unifiedCaseCreationVoiceCallWrapper';
...
const mockGetRecordForVoiceCallTranscript = require('./data/getRecordForVoiceCallTranscript.json');
...
describe('c-unified-case-creation-voice-call-wrapper', () => {
	afterEach(() => {
	...
	it('invokes getRecord for VoiceCallTranscript and pass properties to case creation component', async () => {
		// Create component
		const element = createElement('c-unified-case-creation-voice-call-wrapper', {
			is: UnifiedCaseCreationVoiceCallWrapper
		});
