...
export default class Tl_trailheadAssignments extends LightningElement {
  ...
  @api
  refreshRecommends(){
    this.captureGetRecommendTrailEntries(this.recordId, this.showCompleted);
  }
   ...
   */
  captureGetRecommendTrailEntries(recordId, showCompleted){
    getAllRecommendTrailEntriesApex({recordId:recordId, includeCompleted:showCompleted})
      .then(data => {
