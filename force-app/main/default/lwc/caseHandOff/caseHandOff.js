...
const FIELDS = [CASENUMBER, CASERECORDTYPEID, CASERECORDTYPENAME, PRODUCTID, ARTICLENAME];
...
export default class CaseHandOff extends LightningElement {
	...
	@track contactCenterOptions = [
		{ label: 'Australia Post MyCustomers', value: 'UnifiedAusPostHandoffTriageQueue' },
		{ label: 'StarTrack Service Cloud', value: 'UnifiedStarTrackHandoffTriageQueue' }
	];
