/**
  ...
  * @date         : 01/05/2019
  * @description  : Look up that searches SOQL to provide auto complete behaviour
--------------------------------------- History --------------------------------------------------
01.04.2019    Sameed Khan(Mav3rik)    Created
06/09/2019    Swati.mogadala@auspost.com.au - Created a new property customerlookup to be used on the mail redirect form REQ1886733
10/02/2020    alex.volkov@auspost.com.au - Added a new property numCharsToSearch to control when the search starts
                                           Added a new property filterMap to apply hard filters
                                           Added a new property searchDelay to configure search delay until after the user stopped typing
2021-02-18 - Ranjeewa Silva - Added new 'recordselected' event that is fired when a record is selected from search results.
                              Also added a new property 'context' which can be be used by parents to pass in the context where this component
                              is used. The context data is published back in 'recordselected' event, allowing multiple instances of this component to be
                              used with in the same parent.
**/
